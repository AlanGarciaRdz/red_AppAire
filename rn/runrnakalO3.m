% Código para O3rrer todas las redes neuronales
% PronóstiO3s de Ozono en 10 estaciones

clear; clc;
% Buscar número de semana a partir de la fecha
now = csvread('/root/rn/now.csv');       %archivo O3n la fecha actual
mes=now(1); dia=now(2); hora=now(3);
fechas = csvread('/root/rn/fechas.csv'); %archivo O3n índices de semanas
...
%strout = strcat('O3pron',strftime ("%d_%m_%H_%p", localtime (time ())),'.csv');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% O3rrección O3n filtro de Kalman
%Las Águilas
QRPX.Q = csvread('/root/rn/QO3agu.csv'); QRPX.R = csvread('/root/rn/RO3agu.csv');       
%QRPX.P = csvread('/root/rn/PO3agu.csv'); QRPX.X = csvread('/root/rn/XO3agu.csv');      
QRPX.P=eye(25)*5;
QRPX.X=ones(25,1);              %Quitar esta línea cuando se genere P y X
[pronO3Kal,PO3,XO3]=kalman(inlets(1,1),pronO3Aguilas,QRPX);
csvwrite('PO3agu.csv',PO3); csvwrite('XO3agu.csv',XO3);
O3final(:,1)=pronO3Kal;
%Atemajac
QRPX.Q = csvread('/root/rn/QO3atm.csv'); QRPX.R = csvread('/root/rn/RO3atm.csv');       
%QRPX.P = csvread('/root/rn/PO3atm.csv'); QRPX.X = csvread('/root/rn/XO3atm.csv');      
QRPX.P=eye(25)*5;
QRPX.X=ones(25,1);              %Quitar esta línea cuando se genere P y X
...
O3final(:,2)=pronO3Kal;
%Centro
QRPX.Q = csvread('/root/rn/QO3cen.csv'); QRPX.R = csvread('/root/rn/RO3cen.csv');       
%QRPX.P = csvread('/root/rn/PO3cen.csv'); QRPX.X = csvread('/root/rn/XO3cen.csv');      
QRPX.P=eye(25)*5;
QRPX.X=ones(25,1);              %Quitar esta línea cuando se genere P y X
...
O3final(:,3)=pronO3Kal;
%Las Pintas
QRPX.Q = csvread('/root/rn/QO3lpin.csv'); QRPX.R = csvread('/root/rn/RO3lpin.csv');       
%QRPX.P = csvread('/root/rn/PO3lpin.csv'); QRPX.X = csvread('/root/rn/XO3lpin.csv');      
QRPX.P=eye(25)*5;
QRPX.X=ones(25,1);              %Quitar esta línea cuando se genere P y X
...
O3final(:,4)=pronO3Kal;
%Loma Dorada
QRPX.Q = csvread('/root/rn/QO3ldo.csv'); QRPX.R = csvread('/root/rn/RO3ldo.csv');       
%QRPX.P = csvread('/root/rn/PO3ldo.csv'); QRPX.X = csvread('/root/rn/XO3ldo.csv');      
QRPX.P=eye(25)*5;
QRPX.X=ones(25,1);              %Quitar esta línea cuando se genere P y X
...
O3final(:,5)=pronO3Kal;
%Miravalle
QRPX.Q = csvread('/root/rn/QO3mir.csv'); QRPX.R = csvread('/root/rn/RO3mir.csv');       
%QRPX.P = csvread('/root/rn/PO3mir.csv'); QRPX.X = csvread('/root/rn/XO3mir.csv');      
QRPX.P=eye(25)*5;
QRPX.X=ones(25,1);              %Quitar esta línea cuando se genere P y X
...
O3final(:,6)=pronO3Kal;
%Oblatos
QRPX.Q = csvread('/root/rn/QO3obl.csv'); QRPX.R = csvread('/root/rn/RO3obl.csv');       
%QRPX.P = csvread('/root/rn/PO3obl.csv'); QRPX.X = csvread('/root/rn/XO3obl.csv');      
QRPX.P=eye(25)*5;
QRPX.X=ones(25,1);              %Quitar esta línea cuando se genere P y X
...
O3final(:,7)=pronO3Kal;
%Santa Fé
QRPX.Q = csvread('/root/rn/QO3stfe.csv'); QRPX.R = csvread('/root/rn/RO3stfe.csv');       
%QRPX.P = csvread('/root/rn/PO3sfe.csv'); QRPX.X = csvread('/root/rn/XO3sfe.csv');      
QRPX.P=eye(25)*5;
QRPX.X=ones(25,1);              %Quitar esta línea cuando se genere P y X
...
O3final(:,8)=pronO3Kal;
%Tlaquepaque
QRPX.Q = csvread('/root/rn/QO3tla.csv'); QRPX.R = csvread('/root/rn/RO3tla.csv');       
%QRPX.P = csvread('/root/rn/PO3tla.csv'); QRPX.X = csvread('/root/rn/XO3tla.csv');      
QRPX.P=eye(25)*5;
QRPX.X=ones(25,1);              %Quitar esta línea cuando se genere P y X
...
O3final(:,9)=pronO3Kal;
%Vallarta
QRPX.Q = csvread('/root/rn/QO3val.csv'); QRPX.R = csvread('/root/rn/RO3val.csv');       
%QRPX.P = csvread('/root/rn/PO3val.csv'); QRPX.X = csvread('/root/rn/XO3val.csv');      
QRPX.P=eye(25)*5;
QRPX.X=ones(25,1);              %Quitar esta línea cuando se genere P y X
...
%Archivo de Salida
%csvwrite('O3pron.csv',O3final);


strout = strcat('O3pron',strftime ("%d_%m_%Y_%H_%p", localtime (time ())),'.csv');
csvwrite(strcat('/var/www/html/kml/resultrn/',strout),O3final);
