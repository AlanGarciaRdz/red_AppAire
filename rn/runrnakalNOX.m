% Código para NOXrrer todas las redes neuronales
% PronóstiNOXs de NOX parámetros en 10 estaciones

clear; clc;
% Buscar número de semana a partir de la fecha
now = csvread('/root/rn/now.csv');       %archivo NOXn la fecha actual
mes=now(1); dia=now(2); hora=now(3);
fechas = csvread('/root/rn/fechas.csv'); %archivo NOXn índices de semanas
...
%strout = strcat('NOXpron',strftime ("%d_%m_%H_%p", localtime (time ())),'.csv');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% NOXrrección NOXn filtro de Kalman
%Las Águilas
QRPX.Q = csvread('/root/rn/QNOXagu.csv'); QRPX.R = csvread('/root/rn/RNOXagu.csv');       
QRPX.P = csvread('/root/rn/PNOXagu.csv'); QRPX.X = csvread('/root/rn/XNOXagu.csv');      
...
%Atemajac
QRPX.Q = csvread('/root/rn/QNOXatm.csv'); QRPX.R = csvread('/root/rn/RNOXatm.csv');       
QRPX.P = csvread('/root/rn/PNOXatm.csv'); QRPX.X = csvread('/root/rn/XNOXatm.csv');      
...
%Centro
QRPX.Q = csvread('/root/rn/QNOXcen.csv'); QRPX.R = csvread('/root/rn/RNOXcen.csv');       
QRPX.P = csvread('/root/rn/PNOXcen.csv'); QRPX.X = csvread('/root/rn/XNOXcen.csv');      
...
%Las Pintas
QRPX.Q = csvread('/root/rn/QNOXlpin.csv'); QRPX.R = csvread('/root/rn/RNOXlpin.csv');       
QRPX.P = csvread('/root/rn/PNOXlpin.csv'); QRPX.X = csvread('/root/rn/XNOXlpin.csv');      
...
%Loma Dorada
QRPX.Q = csvread('/root/rn/QNOXldo.csv'); QRPX.R = csvread('/root/rn/RNOXldo.csv');       
QRPX.P = csvread('/root/rn/PNOXldo.csv'); QRPX.X = csvread('/root/rn/XNOXldo.csv');      
...
%Miravalle
QRPX.Q = csvread('/root/rn/QNOXmir.csv'); QRPX.R = csvread('/root/rn/RNOXmir.csv');       
QRPX.P = csvread('/root/rn/PNOXmir.csv'); QRPX.X = csvread('/root/rn/XNOXmir.csv');      
...
%Oblatos
QRPX.Q = csvread('/root/rn/QNOXobl.csv'); QRPX.R = csvread('/root/rn/RNOXobl.csv');       
QRPX.P = csvread('/root/rn/PNOXobl.csv'); QRPX.X = csvread('/root/rn/XNOXobl.csv');      
...
%Santa Fé
QRPX.Q = csvread('/root/rn/QNOXstfe.csv'); QRPX.R = csvread('/root/rn/RNOXstfe.csv');       
QRPX.P = csvread('/root/rn/PNOXsfe.csv'); QRPX.X = csvread('/root/rn/XNOXsfe.csv');      
...
%Tlaquepaque
QRPX.Q = csvread('/root/rn/QNOXtla.csv'); QRPX.R = csvread('/root/rn/RNOXtla.csv');       
QRPX.P = csvread('/root/rn/PNOXtla.csv'); QRPX.X = csvread('/root/rn/XNOXtla.csv');      
...
%Vallarta
QRPX.Q = csvread('/root/rn/QNOXval.csv'); QRPX.R = csvread('/root/rn/RNOXval.csv');       
QRPX.P = csvread('/root/rn/PNOXval.csv'); QRPX.X = csvread('/root/rn/XNOXval.csv');      
...
%Archivo de Salida
%csvwrite('NOXpron.csv',NOXfinal);



strout = strcat('NOXpron',strftime ("%d_%m_%Y_%H_%p", localtime (time ())),'.csv');
csvwrite(strcat('/var/www/html/kml/resultrn/',strout),NOXfinal);
