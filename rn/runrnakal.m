% Código para Correr todas las redes neuronales
% Pronósticos de 5 parámetros en 10 estaciones
...
fechas = csvread('fechas.csv'); %archivo con índices de semanas
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Corrección con filtro de Kalman
%Las Águilas
